...
- A TypeScript backend using the **Vercel AI SDK** (framework of your choice: Next.js, Hono, Express, etc.)
...
- All LLM calls routed through the **AI SDK** (no model-specific SDKs directly)
